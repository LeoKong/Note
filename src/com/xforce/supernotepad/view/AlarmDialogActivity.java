...
public class AlarmDialogActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        NoteDetailDao noteDetailDao=new NoteDetailDao(AlarmDialogActivity.this);
        ...
        try {
        	vibrator = (Vibrator) AlarmDialogActivity.this.getSystemService(Context.VIBRATOR_SERVICE);//初始化震动
        ...
        back.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				Intent intent = new Intent(AlarmDialogActivity.this,MainActivity.class);// 跳转到记事本的avtivity
